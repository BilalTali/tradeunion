...
export default function Show({ auth, district, portfolioHolders }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
        ...
        >
            <Head title={`${district.name} Officers`} />
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <h3 className="text-lg font-medium mb-4">District Information</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <p className="text-sm text-gray-500">State</p>
                                    <p className="font-medium">{district.state?.name || 'Jammu and Kashmir'}</p>
                                </div>
                                <div>
                        ...
                        <div className="p-6">
                            ...
                            {portfolioHolders.length > 0 ? (
                                ...
                                <div className="text-center py-8 text-gray-500 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                                    <p>No portfolios assigned in this district yet.</p>
                                </div>
                            )}
                        </div>
                    </div>
