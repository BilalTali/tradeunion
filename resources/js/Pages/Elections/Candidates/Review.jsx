...
export default function Review({ election, candidates }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Review Nominations" />

            <div className="min-h-screen bg-gray-50 py-12">
                <div className="max-w-7xl mx-auto px-4">
                    {/* Header */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Review Nominations</h1>
                        <p className="text-gray-600">
                            {election.title} - Pending Candidates: {candidates.length}
                        </p>
                    </div>
                                        ...
                                        {rejectingId === candidate.id ? (
                                            ...
                                            <div className="flex gap-3">
                                                <button
                                                    ...
                                                    className="px-6 py-3 bg-green-600 text-black rounded-lg hover:bg-green-700 font-semibold transition shadow-md hover:shadow-lg flex items-center gap-2"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className="px-6 py-3 bg-red-600 text-black rounded-lg hover:bg-red-700 font-semibold transition shadow-md hover:shadow-lg flex items-center gap-2"
                                                >
                                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
