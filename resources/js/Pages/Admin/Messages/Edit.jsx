...
export default function Edit({ auth, message }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        is_active: message.is_active ? true : false,
    });

    const submit = (e) => {
        e.preventDefault();
        post(route('state.messages.update', message.id));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Leadership Message</h2>}
        >
                            ...
                            <form onSubmit={submit} className="space-y-6 max-w-xl">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        accept="image/*"
                                    />
                                    {message.photo_path && <p className="text-sm text-gray-500 mt-1">Current photo exists. Upload new to replace.</p>}
                                ...
                                <div className="flex items-center gap-4">
                                    <PrimaryButton disabled={processing}>Update Message</PrimaryButton>
