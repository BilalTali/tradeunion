...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('state.links.store'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Add Important Link</h2>}
        >
            <Head title="Add Link" />
                        ...
                        <div className="p-6 text-gray-900">
                            <form onSubmit={submit} className="space-y-6 max-w-xl">
                                ...
                                <div className="flex items-center gap-4">
                                    <PrimaryButton disabled={processing}>Add Link</PrimaryButton>
