...
export default function Edit({ auth, achievement }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('state.achievements.update', achievement.id));
    };
                            ...
                            <form onSubmit={submit} className="space-y-6 max-w-xl">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        accept="image/*"
                                    />
                                    {achievement.image_path && <p className="text-sm text-gray-500 mt-1">Current image exists. Upload new to replace.</p>}
