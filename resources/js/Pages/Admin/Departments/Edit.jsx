...
export default function Edit({ department }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        posting_label: department.posting_label || '',
        is_active: department.is_active ?? true,
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('state.departments.update', department.id));
    };

    return (
        <AuthenticatedLayout user={auth.user} header={`Edit Department: ${department.name}`}>
