    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-8 text-center">
                <h2 className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#FF9933] to-[#138808] mb-2 font-serif">Welcome Back</h2>
                <p className="text-gray-600">Sign in to access your union portal</p>
            </div>
